...
1. Follow the prompts from the command line, selecting 'New Jupyter Book' option, providing a path to existing notebooks and creating a new book if needed.
2. `cd <%= name%>` and then `code .` to open the new extension folder in VS Code.
3. Update the README and _toc.yml to your liking.
...
6. Run `Launch Book: <%= name %>` in Azure Data Studio to open your bundled notebooks.
